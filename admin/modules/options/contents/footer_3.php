<div class="footer_3 px-1">
   <h3 class="text-center">Thiết lập cột 3</h3>
         ...
         <div class="d-flex align-items-start pb-3">
            <div class="flex-grow-1 align-self-center overflow-hidden">
               <div class="row">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        <label for="footer_3_twitter"><?php echo getOption('footer_3_twitter', 'label') ?></label>
                        <input type="text" name="footer_3_twitter" id="footer_3_twitter" class="form-control"
                           placeholder="<?php echo getOption('footer_3_twitter', 'label') ?>..."
                           value="<?php echo !empty($oldService) ? $oldService['footer_3_twitter'] : getOption('footer_3_twitter') ?>">
                        <?php echo !empty($errors['footer_3_twitter']) ? form_error('footer_3_twitter', $errors, '<span class="error">', '</span>') : false ?>
                     </div>
                  </div>
               </div>
            </div>
