               ...
               <div class="row">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        ...
                        <textarea type="text" name="footer_4_content" id="footer_4_content" class="form-control editor"
                           placeholder="<?php echo getOption('footer_4_content', 'label') ?>..."><?php echo !empty($oldService) ? $oldService['footer_4_content'] : getOption('footer_4_content') ?></textarea>
