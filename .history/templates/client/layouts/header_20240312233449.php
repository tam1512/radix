               ...
               <div class="col-lg-6 col-12">
                  <div class="topbar-right">
                     ...
                     <div class="search-form active">
                        ...
                        <form class="form" method="get" action="<?php echo getLinkClient('search') ?>">
                           <input name="keyword" placeholder="<?php echo getOption("header_placeholder_search") ?>..."
                              type="search" />
                        </form>
                     </div>
                     <!--/ End Search Form -->
                  ...
                  <div class="mainmenu">
                     <nav class="navigation">
                        <?php 
                           ...
                           $dataMenu = !empty($menuJson) ? json_decode(html_entity_decode($menuJson), true) : false;
                           getMenu($dataMenu);
                        ?>
                        <!-- <ul class="nav menu">
                           ...
                           <li>
                              ...
                              <ul class="dropdown">
                                 <li><a href="<?php echo getLinkClient('pages', 'about') ?>">About Us</a></li>
                                 <li><a href="<?php echo getLinkClient('pages', 'team') ?>">Our Team</a></li>
                              </ul>
                           </li>
                           <li><a href="<?php echo getLinkClient('services') ?>">Services</a></li>
                           <li><a href="<?php echo getLinkClient('portfolios') ?>">Portfolio</a></li>
                           <li><a href="<?php echo getLinkClient('blogs') ?>">Blogs</a></li>
                           <li><a href="<?php echo getLinkClient('contact') ?>">Contact</a></li>
                        </ul> -->
                     </nav>
                     <!-- Button -->
                     <div class="button">
