                  ...
                  <div class="mainmenu">
                     <nav class="navigation">
                        <ul class="nav menu">
                           ...
                           <li><a href="<?php echo getLinkClient('pages', 'services') ?>">Services</a></li>
                           <li><a href="<?php echo getLinkClient('pages', 'portfolios') ?>">Portfolio</a></li>
                           <li><a href="<?php echo getLinkClient('pages', 'blogs') ?>">Blogs</a></li>
                           <li><a href="<?php echo getLinkClient('pages', 'contact') ?>">Contact</a></li>
                        </ul>
                     </nav>
                     <!-- Button -->
                     <div class="button">
