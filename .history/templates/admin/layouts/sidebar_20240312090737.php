...
$groupId = getGroupId();
 ...
 if($isRoot) {
   ...
   $isListsContacts = checkPermission($permissionData, 'users', 'lists');;
   $isListsContactCategories = checkPermission($permissionData, 'users', 'lists');;

   $isListsComments = checkPermission($permissionData, 'users', 'lists');;

   $isListsSubscribe = checkPermission($permissionData, 'users', 'lists');;

   $isListsOptions = checkPermission($permissionData, 'users', 'lists');;
 }
?>
