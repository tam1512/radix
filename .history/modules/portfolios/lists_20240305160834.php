<?php 
   ...
   $category = "";
   if(isGet()) {
      if(!empty(getBody('get')['c'])) {
         $category = getBody('get')['c'];
      }
   }
         ...
         <div class="col-12">
            ...
            <div class="portfolio-nav">
               ...
               <ul class="tr-list list-inline" id="portfolio-menu">
                  <li data-filter="*" class="cbp-filter-item <?php echo !empty($category) ? "" : "active" ?>">
                     All Works
                  ...
                  <?php 
                     if(!empty($arrCates)): 
                        foreach($arrCates as $cate):
                  ?>
                  <li data-filter=".<?php echo $cate['name'] ?>"
                     class="cbp-filter-item <?php echo !empty($category) && $category == $cate['name'] ? 'active' : false ?>">
                     <?php echo $cate['name'] ?>
                     <div class="cbp-filter-counter"></div>
                  </li>
                  <?php 
