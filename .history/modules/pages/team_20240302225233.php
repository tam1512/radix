         ...
         <div class="col-lg-3 col-md-6 col-12">
            ...
            <div class="single-team">
               ...
               <div class="t-bottom">
                  ...
                  <ul class="t-social">
                     <li>
                        <a href="<?php echo $item['team_member_facebook'] ?>"><i class="fa fa-facebook"></i></a>
                     </li>
                     <li>
                        <a href="<?php echo $item['team_member_twitter'] ?>"><i class="fa fa-twitter"></i></a>
                     </li>
                     <li>
                        <a href="<?php echo $item['team_member_linkedin'] ?>"><i class="fa fa-linkedin"></i></a>
                     </li>
                     <li>
                        <a href="<?php echo $item['team_member_behance'] ?>"><i class="fa fa-behance"></i></a>
                     </li>
                  </ul>
               </div>
            </div>
