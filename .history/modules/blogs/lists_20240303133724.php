                  ...
                  <div class="single-blog">
                     ...
                     <div class="blog-bottom">
                        <div class="blog-inner">
                           <h4>
                              <a
                                 href="<?php echo getLinkClient('pages', 'blog-single', ["id" => $item['id']]) ?>"><?php echo $item['title'] ?></a>
                           </h4>
                  ...
                  <li class="prev">
                     <a href="
                        <?php 
                           ...
                           echo getLinkClient('pages', 'blogs', ['page'=>$prevPage]);
                        ?>">
                  ...
                  <?php 
                     if(!empty($numPage)) {
                        ...
                        if($numPage <= $limitPagination) {
                           for($i = 1; $i <= $numPage; $i++) {
                              if($page == $i) {
                                 echo '<li class="active"><a href="'.getLinkClient('pages', 'blogs', ['page' => $i]).'">'.$i.'</a></li>';
                              } else {
                                 echo '<li><a href="'.getLinkClient('pages', 'blogs', ['page' => $i]).'">'.$i.'</a></li>';
                              }
                           }
                        } else {
                           for($i = $begin; $i <= $end; $i++) {
                  ...
                  <li class="next">
                     <a href="
                        <?php
                           ...
                           echo getLinkClient('pages', 'blogs', ['page' => $nextPage]);
                        ?>">
