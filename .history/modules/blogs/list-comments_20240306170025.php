   ...
   <div class="comments-body">
      ...
      <div class="single-comments">
         <div class="main">
            <div class="head">
               <img
                  src="<?php echo !empty($comment['user_id']) && !empty($userInfor['avatar']) ? $userInfor['avartar'] : getAvatar($comment['email']) ?>"
                  alt="#">
            </div>
            <div class="body">
               <h4>
                  <?php echo empty($comment['user_id']) ? $comment['fullname'] : $comment['fullname']. ' <label class="badge badge-danger">'.getGroupByUserId($comment['user_id']).'</lable>' ?>
               </h4>
               <div class="comment-info">
                  <p><span><?php echo getDateFormat($comment['create_at'], 'd/m/Y') ?> at<i
                        ...
                        href="<?php echo getLinkClient('blogs', 'detail', ['id' => $id,'comment_id' => $comment['id']]).'#comment-form' ?>"><i
