                     ...
                     <div class="blog-inner">
                        <div class="blog-top">
                           ...
                           <ul class="social-share">
                              ...
                              <li>
                                 <a
                                    href="<?php echo "http://pinterest.com/pin/create/button/?url=".getLinkClient('blogs', 'detail', ['id' => $id]) ?>">
                                    <i class="fa fa-pinterest"></i>
                                 </a>
                              </li>
                              <li>
                                 <a
                                    href="<?php echo "https://plus.google.com/share?url=".getLinkClient('blogs', 'detail', ['id' => $id]) ?>">
