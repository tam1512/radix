                  ...
                  <li class="prev">
                     <a href="
                        <?php 
                           ...
                           echo getLinkClient('blogs', 'category', ['id'=>$id, 'page'=>$prevPage]);
                        ?>">
                  ...
                  <?php 
                     if(!empty($numPage)) {
                        ...
                        if($numPage <= $limitPagination) {
                           for($i = 1; $i <= $numPage; $i++) {
                              if($page == $i) {
                                 echo '<li class="active"><a href="'.getLinkClient('blogs', 'category', ['id' => $id, 'page' => $i]).'">'.$i.'</a></li>';
                              } else {
                                 echo '<li><a href="'.getLinkClient('blogs', 'category', ['id' => $id, 'page' => $i]).'">'.$i.'</a></li>';
                              }
                           }
                        } else {
                           for($i = $begin; $i <= $end; $i++) {
                  ...
                  <li class="next">
                     <a href="
                        <?php
                           ...
                           echo getLinkClient('blogs', 'category', ['id' => $id, 'page' => $nextPage]);
                        ?>">
