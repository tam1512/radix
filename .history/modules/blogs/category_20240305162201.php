                        ...
                        <div class="blog-inner">
                           ...
                           <div class="meta">
                              <span><i class="fa fa-bolt"></i>
                                 <a href="<?php echo getLinkClient('blogs', 'category', ["id" => $cate['id']]) ?>">
                                    <?php echo $cateName ?>
                                 </a>
                              </span>
                              <span><i
                  ...
                  <li class="prev">
                     <a href="
                        <?php 
                           ...
                           echo getLinkClient('blogs', '', ['page'=>$prevPage]);
                        ?>">
                  ...
                  <?php 
                     if(!empty($numPage)) {
                        ...
                        if($numPage <= $limitPagination) {
                           for($i = 1; $i <= $numPage; $i++) {
                              if($page == $i) {
                                 echo '<li class="active"><a href="'.getLinkClient('blogs', '', ['page' => $i]).'">'.$i.'</a></li>';
                              } else {
                                 echo '<li><a href="'.getLinkClient('blogs', '', ['page' => $i]).'">'.$i.'</a></li>';
                              }
                           }
                        } else {
                           for($i = $begin; $i <= $end; $i++) {
                  ...
                  <li class="next">
                     <a href="
                        <?php
                           ...
                           echo getLinkClient('blogs', '', ['page' => $nextPage]);
                        ?>">
