                     ...
                     <div class="blog-inner">
                        <div class="blog-top">
                           ...
                           <ul class="social-share">
                              <li>
                                 <a href="<?php echo !empty($facebook) ? "https://www.facebook.com/sharer/sharer.php?u=$facebook" : false  ?>"
                                    target="_blank">
                                    <i class="fa fa-facebook"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="<?php echo !empty($twitter) ? $twitter : false  ?>" target="_blank">
                                    <i class="fa fa-twitter"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="<?php echo !empty($linkedin) ? $linkedin : false  ?>" target="_blank">
