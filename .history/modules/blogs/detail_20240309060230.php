                  ...
                  <div class="single-blog">
                     ...
                     <div class="blog-inner">
                        <div class="blog-top">
                           <div class="meta">
                              <span><i class="fa fa-bolt"></i><a
                                    href="<?php echo getLinkModule('blog_categories', $blogDefault['id']) ?>"><?php echo !empty($blogDefault['cate_name']) ? $blogDefault['cate_name'] : false  ?></a></span>
                              <span><i
                        ...
                        <div class="bottom-area">
                           <!-- Next Prev -->
                           <ul class="arrow">
                              <li class="prev"><a href="<?php echo getLinkModule('blogs', $prevId) ?>"><i
                                       class="fa fa-angle-double-left"></i>Previews Posts</a>
                              </li>
                              <li class="next"><a href="<?php echo getLinkModule('blogs', $nextId) ?>">Next
