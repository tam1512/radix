...
<section id="hero-area" class="hero-area">
   ...
   <div class="slider-area">
      ...
      <div class="single-slider"
         style="background-image: url('<?php echo _WEB_HOST_TEMPLATE.'/assets/images/' ?>slider/slider-image1.jpg')">
         <div class="container">
            <div class="row">
               <div class="col-lg-7 col-md-6 col-12">
                  ...
                  <div class="slider-text">
                     <h1>
                        Radix <span>Business</span> World That Possible
                        anything<span>!</span>
                     </h1>
                     <p>
                     ...
                     <div class="button">
                        ...
                        <a href="https://www.youtube.com/watch?v=FZQPhrdKjow" class="btn video video-popup mfp-fade"><i
               ...
               <div class="col-lg-5 col-md-6 col-12">
                  ...
                  <div class="image-gallery">
                     <div class="single-image">
                        <img src="<?php echo _WEB_HOST_TEMPLATE.'/assets/images/' ?>slider/gallery-image1.jpg"
                           alt="#" />
                     </div>
                     <div class="single-image two">
                        <img src="<?php echo _WEB_HOST_TEMPLATE.'/assets/images/' ?>slider/gallery-image2.jpg"
                           alt="#" />
                     </div>
                  </div>
                  <!--/ End Image Gallery -->
      ...
      <div class="single-slider slider-right"
         style="background-image: url('<?php echo _WEB_HOST_TEMPLATE.'/assets/images/' ?>slider/slider-image2.jpg')">
         <div class="container">
            <div class="row">
               <div class="col-lg-5 col-md-6 col-12">
                  <!-- Image Gallery -->
            ...
            <div class="row">
               <div class="col-lg-10 offset-lg-1 col-12">
                  ...
                  <div class="slider-text text-center">
                     <h1>
                        Build your website with Radix Multipurpose
         ...
         <div class="col-lg-6 col-12 wow fadeInLeft" data-wow-delay="0.6s">
            ...
            <div class="about-video">
               <div class="single-video overlay">
                  ...
                  <img src="<?php echo _WEB_HOST_TEMPLATE.'/assets/images/' ?>gallery-4.jpg" alt="#" />
               </div>
            </div>
            <!--/ End Video -->
         </div>
                  ...
                  <div class="cbp-item website animation printing">
                     <div class="portfolio-single">
                        <div class="portfolio-head">
                           <img src="<?php echo _WEB_HOST_TEMPLATE.'/assets/images/' ?>portfolio/p1.jpg" alt="#" />
                        </div>
                        <div class="portfolio-hover">
                           ...
                           <div class="button">
                              <a class="primary" data-fancybox="gallery"
                                 href="<?php echo _WEB_HOST_TEMPLATE.'/assets/images/' ?>portfolio/p1.jpg"><i
