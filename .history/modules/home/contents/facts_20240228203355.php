         ...
         <div class="col-lg-7 col-12">
            <div class="row">
               <?php 
                  if(!empty($arrFacts)): 
                     $time = 0.6;
                     foreach($arrFacts as $item):
               ?>
               <div class="col-lg-6 col-md-6 col-12 wow fadeIn" data-wow-delay="<?php echo $time; $time += 0.2 ?>s">
                  <!-- Single Fact -->
                  <div class="single-fact">
                     <div class="icon">
                        <?php echo (!empty($arrFacts['facts_item_icon']) ? html_entity_decode($arrFacts['facts_item_icon']) : false) ?>
                     </div>
                     <div class="counter">
                        <p><span
                              class="count"><?php echo (!empty($arrFacts['facts_item_number']) ? $arrFacts['facts_item_number'] : false) ?></span>
                        </p>
                        <h4><?php echo (!empty($arrFacts['facts_item_desc']) ? $arrFacts['facts_item_desc'] : false) ?>
                        </h4>
                     </div>
                  </div>
                  <!--/ End Single Fact -->
