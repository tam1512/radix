                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="form-group">
                           <label
                              for="home_blogs_title_page"><?php echo getOption('home_blogs_title_page', 'label') ?></label>
                           <input type="text" name="home_blogs_title_page" id="home_blogs_title_page"
                              class="form-control"
                              placeholder="<?php echo getOption('home_blogs_title_page', 'label') ?>..."
                              value="<?php echo !empty($old) ? $old['home_blogs_title_page'] : getOption('home_blogs_title_page') ?>">
                     ...
                     <div class="col-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="home_blogs_title-bg" id="home_blogs_title-bg" class="form-control"
                              ...
                              value="<?php echo !empty($old) ? $old['home_blogs_title-bg'] : getOption('home_blogs_title-bg') ?>">
                           <?php echo !empty($errors['home_blogs_title-bg']) ? form_error('home_blogs_title-bg', $errors, '<span class="error">', '</span>') : false ?>
                        </div>
                     </div>
                     <div class="col-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="home_blogs_title" id="home_blogs_title" class="form-control"
                              ...
                              value="<?php echo !empty($old) ? $old['home_blogs_title'] : getOption('home_blogs_title') ?>">
                     ...
                     <div class="col-12">
                        <div class="form-group">
                           ...
                           <textarea type="text" name="home_blogs_content" id="home_blogs_content"
                              ...
                              placeholder="<?php echo getOption('home_blogs_content', 'label') ?>..."><?php echo !empty($old) ? $old['home_blogs_content'] : getOption('home_blogs_content') ?></textarea>
