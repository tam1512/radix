                  ...
                  <div class="col-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="home_services_title-bg" id="home_services_title-bg"
                           ...
                           value="<?php echo getOption('home_services_title-bg') ?>">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="home_services_title" id="home_services_title" class="form-control"
                           ...
                           value="<?php echo getOption('home_services_title') ?>">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        ...
                        <textarea type="text" name="home_services_content" id="home_services_content"
                           class="form-control"
                           placeholder="<?php echo getOption('home_services_content', 'label') ?>..."><?php echo getOption('home_services_content') ?></textarea>
