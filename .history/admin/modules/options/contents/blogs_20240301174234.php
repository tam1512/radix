         ...
         <div class="d-flex align-items-start border-bottom pb-3">
            <div class="flex-grow-1 align-self-center overflow-hidden">
               <div class="row">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        <label for="home_blogs_btn"><?php echo getOption('home_blogs_btn', 'label') ?></label>
                        <input type="text" name="home_blogs_btn" id="home_blogs_btn" class="form-control"
                           placeholder="<?php echo getOption('home_blogs_btn', 'label') ?>..."
                           value="<?php echo !empty($oldService) ? $oldService['home_blogs_btn'] : getOption('home_blogs_btn') ?>">
                        <?php echo !empty($errors['home_blogs_btn']) ? form_error('home_blogs_btn', $errors, '<span class="error">', '</span>') : false ?>
                     </div>
                  </div>
                  <div class="col-12">
                     <div class="form-group">
                        <label for="home_blogs_btn_link"><?php echo getOption('home_blogs_btn_link', 'label') ?></label>
                        <input type="text" name="home_blogs_btn_link" id="home_blogs_btn_link" class="form-control"
                           placeholder="<?php echo getOption('home_blogs_btn_link', 'label') ?>..."
                           value="<?php echo !empty($oldService) ? $oldService['home_blogs_btn_link'] : getOption('home_blogs_btn_link') ?>">
                        <?php echo !empty($errors['home_blogs_btn_link']) ? form_error('home_blogs_btn_link', $errors, '<span class="error">', '</span>') : false ?>
                     </div>
                  </div>
               </div>
            </div>
