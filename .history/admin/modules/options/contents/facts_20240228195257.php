                  ...
                  <div class="col-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="home_facts[facts_title_sub]" id="facts_title_sub" class="form-control"
                           ...
                           value="<?php echo !empty($arrAbout['facts_title_sub']) ? $arrAbout['facts_title_sub'] : false ?>">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="home_facts[facts_title]" id="facts_title" class="form-control"
                           placeholder="Tiêu đề..."
                           value="<?php echo !empty($arrAbout['facts_title']) ? $arrAbout['facts_title'] : false ?>">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        ...
                        <textarea type="text" name="home_facts[facts_desc]" id="facts_desc" class="form-control editor"
                           placeholder="Mô tả..."><?php echo !empty($arrAbout['facts_desc']) ? html_entity_decode($arrAbout['facts_desc']) : false ?></textarea>
