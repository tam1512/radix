...
$groupId = getGroupId();
 ...
 if($isRoot) {
    ...
    $checkPermission = checkPermission($permissionData, 'portfolios', 'add');
 }

 if(!$checkPermission) {
   setFlashData('msg', 'Bạn không có quyền thêm Dự Án');
   ...
   <div class="row">
      <div class="col">
         ...
         <form action="" method="post">
            ...
            <button class="btn btn-primary" type="submit">Thêm dự án</button>
         </form>
         <br>
      </div>
   </div>
