                                 ...
                                 <tr>
                                    ...
                                    <td class="text-center">
                                       <a class="btn btn-success"
                                          href="<?php echo !empty($keyword) ? getLinkAdmin('contacts', '', ['keyword'=>$keyword, 'cate_id'=>$department["id"], 'user_id' => $userId]) : getLinkAdmin('contacts', '', ['cate_id'=>$department["id"], 'user_id' => $userId]) ?>">Chọn</a>
                                    </td>
                                 </tr>
                                 <?php 
                                    endforeach; else:
