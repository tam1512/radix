...
$groupId = getGroupId();
 ...
 if($isRoot) {
    ...
    $checkPermission = checkPermission($permissionData, 'contact', 'lists');
    $isEdit = checkPermission($permissionData, 'contact', 'edit');
    $isDelete = checkPermission($permissionData, 'contact', 'delete');
 }
