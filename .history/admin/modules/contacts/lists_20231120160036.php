...
$listContactOnPage = getRaw("SELECT contacts.id, contacts.fullname, contacts.email, contacts.message, contacts.note, contacts.status, contacts.create_at, contacts.department_id, departments.name AS department_name FROM contacts INNER JOIN departments ON departments.id = contacts.department_id $filter ORDER BY contacts.create_at DESC LIMIT $offset, $contactOnPage");
      ...
      <table class="table table-bordered">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a
                     href="<?php echo getLinkAdmin('contacts', 'edit', ['department_id'=>$contact['department_id']]) ?>">
               ...
               <td class="text-center">
                  ...
                  <a class="btn btn-danger mt-4" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"
