               ...
               <div class="col">
                  <div class="form-group">
                     ...
                     <input type="text" id="name" name="fullname" class="form-control" disabled
                        placeholder="Họ tên người bình luận..." value="<?php echo $fullname ?>">
                  </div>
                  <div class="form-group">
                     <label for="email">Email người bình luận:</label>
                     <input type="text" id="name" name="email" class="form-control" disabled
                        placeholder="Email người bình luận..." value="<?php echo $email ?>">
                  </div>
                  <div class="form-group">
                     <label for="website">Website người bình luận:</label>
                     <input type="text" id="name" name="website" class="form-control" disabled
                        placeholder="website người bình luận..." value="<?php echo $email ?>">
                  </div>
                  <div class="form-group">
                     <label for="content">Nội dung:</label>
                     <textarea type="text" id="name" name="content" class="form-control" disabled
                        placeholder="Nội dung..."><?php echo $message ?></textarea>
                  </div>
                  <div class="form-group">
