...
$groupId = getGroupId();
 ...
 if($isRoot) {
    ...
    $checkPermission = checkPermission($permissionData, 'contact_types', 'add');
 }

 if(!$checkPermission) {
   setFlashData('msg', 'Bạn không có quyền thêm Loại liên hệ');
...
<form action="" method="post">
   ...
   <button type="submit" class="btn btn-success">Thêm loại liên hệ</button>
</form>