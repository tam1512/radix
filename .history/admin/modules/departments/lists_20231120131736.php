...
// Số lượng dịch vụ
$countRowDepartments = getRows("SELECT id FROM blog_categories $filter");
...
$listDepartmentOnPage = getRaw("SELECT id, name, create_at, user_id, (SELECT count(blogs.id) FROM blogs WHERE blogs.category_id = blog_categories.id) as blogs_count FROM blog_categories $filter ORDER BY create_at DESC LIMIT $offset, $departmentOnPage");
         ...
         <div class="col-6">
            ...
            ?>
                  <tr>
                     ...
                     <td>
                        <a
                           href="<?php echo getLinkAdmin('blog_categories', '', ['id' => $portfolioCategories['id'], 'view' => 'edit']) ?>">
                     ...
                     <td class="text-center">
                        <a class="btn btn-warning"
                           href="<?php echo getLinkAdmin('blog_categories', '', ['id' => $portfolioCategories['id'], 'view' => 'edit']) ?>"><i
                              class="fa fa-edit"></i></a>
                     </td>
                     <td class="text-center">
                        <a class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"
                           href="<?php echo getLinkAdmin('blog_categories', 'delete', ['id' => $portfolioCategories['id']]) ?>"><i
