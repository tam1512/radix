   ...
   <div class="container-fluid">
      ...
      <table class="table table-bordered table-responsive">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td class="text-center">
                  <a class="btn btn-warning"
                     href="<?php echo getLinkAdmin('blogs', 'edit', ['id' => $blog['id']]) ?>"><i
                        class="fa fa-edit"></i></a>
               </td>
               <?php endif; if($isDelete): ?>
               <td class="text-center">
                  <a class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"
                     href="<?php echo getLinkAdmin('blogs', 'delete', ['id' => $blog['id']]) ?>"><i
            ...
            ?>
            <tr>
               <td colspan="8" class="text-center alert alert-danger">Không có bài viết</td>
            </tr>
            <?php endif; ?>
         </tbody>
      </table>
