...
$listsubscribeOnPage = getRaw("SELECT subscribe.*, blogs.title FROM subscribe JOIN blogs ON blogs.id = subscribe.blog_id $filter ORDER BY subscribe.create_at DESC LIMIT $offset, $subscribeOnPage");
         ...
         <tbody>
            ...
            <tr style="background: <?php echo $color ?>">
               ...
               <td>
                  <div class="">
                     Họ và tên:
                     <a href="<?php echo getLinkAdmin('subscribe', 'edit', ['id'=>$comment['id']]) ?>">
