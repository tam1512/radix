...
if(isPost()) {
   ...
   if(empty($errors)) {
      ...
      $updateStatusComment = update('comments', $dataUpdateComment, "user_id = $userId");
      if($updateStatus && $updateStatusComment) {
...
<div class="container-fluid">
   ...
   <form action="" method="POST">
      ...
      <button type="submit" class="btn btn-primary">Lưu thay đổi</a>
   </form>
</div>
<br>
<?php
