...
$userDetail = firstRaw("SELECT fullname, email, about_content, contact_facebook, contact_twitter, contact_linkedin, contact_printerest  FROM users WHERE id = $userId");
