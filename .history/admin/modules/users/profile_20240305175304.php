...
$userDetail = firstRaw("SELECT fullname, email, avatar, about_content, contact_facebook, contact_twitter, contact_linkedin, contact_printerest  FROM users WHERE id = $userId");
...
if(isPost()) {
   ...
   if(empty($errors)) {
      $dataUpdate = [
         ...
         'contact_printerest' => $contactPrinterest,
